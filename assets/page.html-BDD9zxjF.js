import{c as s,e as r,f as c,a as n,d as l,F as m,h as u,u as h,b as g,r as k,o,t as b,i as v,j as y,k as t}from"./app-fgsi4zhG.js";const w={__name:"page.html",setup(f){const p=v({setup(){const a=y("Hello world!"),e=i=>{a.value=i.target.value};return()=>[t("p",[t("span","输入: "),t("input",{value:a.value,onInput:e})]),t("p",[t("span","输出: "),a.value])]}});return(a,e)=>{const i=k("Badge");return o(),s("div",null,[r(` ---
# 这是文章的标题
title: 页面配置
# 你可以自定义封面图片
